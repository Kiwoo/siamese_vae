...
class mymodel(object):
	...
	def _init(self, img_shape, latent_dim):
		...
		latent_z_test = self.sample_latent_var(mu_test, logvar_test)
		self.reconst_test = self.decoder(latent_z_test)
		...
		self.vaeloss = 10000*self.siam_loss + 50000*self.kl_loss1 + 50000*self.kl_loss2 + self.reconst_error1 + self.reconst_error2
