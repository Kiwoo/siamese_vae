...
def summary_writer(dir = None):
    return tf.summary.FileWriter(dir, get_session().graph)
...
def conv2d_transpose(x, filter_shape, output_shape, name, stride=(1,1), pad="SAME", dtype=tf.float32, collections=None, summary_tag=None):
